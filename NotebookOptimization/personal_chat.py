...
class PersonalChat(QFrame):
    def __init__(self, group_code, user_name, main_window):
        ...
        chat_label.setStyleSheet("""
            ...
            color: #003C30;
        """)
        chat_label.setFixedSize(200, 50)
        ...
        self.users_list.setFixedWidth(180)
        ...
        """)
        self.users_list.setFont(QFont("Inter", 14))
    ...
    def add_message_widget(self, msg_id, sender, text, timestamp):
        ...
        message_frame.setStyleSheet("""
            ...
            padding: 10px;
        """)
        message_frame.setFixedWidth(550)
    ...
    def check_updates(self, force=False):
        ...
        try:
            current_count = get_private_message_count(
                self.group_code,
                self.user_name,
